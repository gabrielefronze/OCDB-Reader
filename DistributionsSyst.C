...
void DistributionsSyst(TString beginningFile, TString endFile){
	...
	TH1D *beginningDarkCurrentDistribution=new TH1D("pp current distribution", "", 17, 0., 1.7);
	TH1D *endDarkCurrentDistribution=new TH1D("PbPb current distribution", "", 17, 0., 1.7);
